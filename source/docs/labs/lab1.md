...
## Выводы
В ходе лабораторной работы были освоены принципы создания статических сайтов-портфолио с использованием MkDocs.
Также были изучены базовые принципы работы с системой контроля версий Git и платформой GitHub.
Освоена базовая настройка темы оформления и конфигурационного файла.

## Исходный код
Исходный код в репозитории: https://github.com/timgusev777/timgusev777.github.io